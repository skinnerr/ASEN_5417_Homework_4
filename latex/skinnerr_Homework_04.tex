...
-1 \le \theta \le 1
\end{equation}
using second-order central differences with 50 unequally-spaced grid points obtained from
\begin{equation}
\theta_i = \cos \left[ \pi (i-1) / N \right]
\;,\qquad
j = 1, \dots, N \!\! + \!\! 1
\end{equation}
where the total number of grid points is $N = 51$. Solve the resulting system using LU-decomposition, and compare results to the exact solution.
